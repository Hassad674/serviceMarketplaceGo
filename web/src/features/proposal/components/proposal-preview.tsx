...
import { Calendar, DollarSign, Layers, Tag } from "lucide-react"
import { useTranslations } from "next-intl"
import { cn } from "@/shared/lib/utils"
import type { ProposalFormData } from "../types"
import { computeProposalTotal } from "../types"
...
export function ProposalPreview({ formData }: ProposalPreviewProps) {
  ...
  const totalBudget = computeProposalTotal(formData)
    ...
    >
      ...
      <div className="mt-4 space-y-4">
        ...
        <PreviewRow
          icon={Layers}
          label={t("paymentType")}
          value={formData.paymentType === "escrow" ? t("escrow") : t("invoice")}
        />
