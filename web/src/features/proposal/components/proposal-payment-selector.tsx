...
import type { ProposalPaymentType } from "../types"

type ProposalPaymentSelectorProps = {
  value: ProposalPaymentType
  onChange: (value: ProposalPaymentType) => void
}

export function ProposalPaymentSelector({ value, onChange }: ProposalPaymentSelectorProps) {
