...
type ProposalMilestoneEditorProps = {
  milestones: ProposalMilestone[]
  onChange: (milestones: ProposalMilestone[]) => void
}

export function ProposalMilestoneEditor({ milestones, onChange }: ProposalMilestoneEditorProps) {
  const t = useTranslations("proposal")

  function updateMilestone(id: string, field: keyof ProposalMilestone, value: string) {
    onChange(
      milestones.map((m) =>
...
type MilestoneItemProps = {
  ...
  index: number
  canDelete: boolean
  onUpdate: (field: keyof ProposalMilestone, value: string) => void
  onDelete: () => void
}
