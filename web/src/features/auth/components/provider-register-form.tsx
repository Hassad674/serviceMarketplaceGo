...
// Step-2 freelance form — visual port to Soleil v2.
//
// IMPORTANT (locked by the design batch contract):
//   - The list of fields collected (first_name, last_name, email,
//     password, confirm_password) is unchanged.
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
          <div className="space-y-1.5">
            ...
            <input
              ...
              className={inputStateClasses(Boolean(errors.first_name))}
          ...
          <div className="space-y-1.5">
            ...
            <input
              ...
              className={inputStateClasses(Boolean(errors.last_name))}
