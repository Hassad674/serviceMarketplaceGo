/**
 * Shared reporting types. The reporting feature is consumed entirely
 * cross-feature (messaging, job) — its UX surface lives in `shared/`
 * (P9). Internal-only types stay here as well to avoid a stale split.
 */
