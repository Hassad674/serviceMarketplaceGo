...
const features = [
  {
    icon: Building2,
    title: "Agencies",
    description: "Manage your team, land missions and grow your business on a platform built for scale.",
    href: "/agencies",
    linkLabel: "Browse agencies",
    iconBg: "bg-blue-100",
  ...
  },
  {
    icon: User,
    title: "Freelancers",
    description: "Find missions matching your skills, manage invoices and build your reputation.",
    href: "/freelances",
    linkLabel: "Browse freelancers",
    iconBg: "bg-rose-100",
  ...
  },
  {
    icon: Briefcase,
    title: "Enterprises",
    description: "Publish projects and find the ideal service providers in just a few clicks.",
    href: "/projects",
    ...
    <main className="flex min-h-screen flex-col">
      ...
      <section className="gradient-hero relative flex min-h-[80vh] flex-col items-center justify-center overflow-hidden px-6 pt-16 text-center">
        ...
        <h1 className="relative max-w-4xl text-4xl font-bold leading-tight tracking-tight text-white sm:text-5xl lg:text-6xl">
          The B2B marketplace that connects agencies, freelancers and enterprises
        </h1>
        <p className="relative mt-6 max-w-2xl text-lg leading-relaxed text-white/80">
          Find the best service providers, publish your projects and collaborate
          with confidence on a platform built for professionals.
        </p>
