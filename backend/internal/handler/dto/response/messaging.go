...
// of the conversation (Stripe Dashboard semantics). OtherUserID is the
// other participant's user id, still needed by the proposal + call
// subsystems which haven't migrated away from user-anchored targeting.
