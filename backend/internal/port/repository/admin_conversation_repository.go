...
type AdminConversationRepository interface {
	...
	// UpdateMessageModeration + HideMessage removed in Phase 7 — admin
	// moderation goes through ModerationResultsRepository.MarkReviewed
	// now (single source of truth for the verdict).
}
