...
// UpdateMessageModeration + HideMessage removed in Phase 7. The
// admin moderation pipeline now writes to moderation_results.MarkReviewed
// exclusively — see app/admin/message_moderation.go.
