...
var (
	...
	ErrInvalidSide               = errors.New("invalid review side")
	ErrInvalidSubCriteriaForSide = errors.New("provider-side reviews cannot carry timeliness/communication/quality")
	ErrReviewWindowClosed        = errors.New("the 14-day review window has closed for this proposal")
)
