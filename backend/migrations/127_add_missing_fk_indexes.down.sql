...
DROP INDEX IF EXISTS idx_counter_proposals_proposer_id;
...
DROP INDEX IF EXISTS idx_referral_commissions_referral_id;
DROP INDEX IF EXISTS idx_referral_commissions_proposal_id;
...
DROP INDEX IF EXISTS idx_organization_invitations_target_user_id;
DROP INDEX IF EXISTS idx_organization_invitations_inviter_id;
