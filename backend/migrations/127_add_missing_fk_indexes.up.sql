...
-- dispute_counter_proposals.proposer_id — part of disputes feature, lookup by
-- the user who made the offer (e.g. "show my pending counter offers").
CREATE INDEX IF NOT EXISTS idx_dispute_counter_proposals_proposer_id
    ON dispute_counter_proposals (proposer_id);
...
CREATE INDEX IF NOT EXISTS idx_organization_invitations_invited_by_user_id
